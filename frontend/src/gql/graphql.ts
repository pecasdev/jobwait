    ...
    userById?: {
        ...
        prompts: Array<{
            ...
            response?:
                | ({ __typename: "IntResponse" } & {
                      " $fragmentRefs"?: {
                          SomeIntResponseFragment: SomeIntResponseFragment;
                      };
                  })
                | ({ __typename: "StrResponse" } & {
                      " $fragmentRefs"?: {
                          SomeStrResponseFragment: SomeStrResponseFragment;
                      };
                  })
                | null;
        }>;
...
export type SomeIntResponseFragment = {
    __typename?: "IntResponse";
    intResponse: number;
} & { " $fragmentName"?: "SomeIntResponseFragment" };

export type SomeStrResponseFragment = {
    __typename?: "StrResponse";
    strResponse: string;
} & { " $fragmentName"?: "SomeStrResponseFragment" };
...
export type AddUserMutation = {
    __typename?: "Mutation";
    addUser?: { __typename?: "User"; userID: string } | null;
};
    ...
    definitions: [
        {
            ...
            name: { kind: "Name", value: "SomeIntResponse" },
            typeCondition: {
                kind: "NamedType",
                name: { kind: "Name", value: "IntResponse" },
            },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<SomeIntResponseFragment, unknown>;
export const SomeStrResponseFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "SomeStrResponse" },
            typeCondition: {
                kind: "NamedType",
                name: { kind: "Name", value: "StrResponse" },
            },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
...
} as unknown as DocumentNode<SomeStrResponseFragment, unknown>;
